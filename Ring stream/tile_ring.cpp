...
float OFM[CONV_OUT_CHANNELS][CONV_OUT_HEIGHT][CONV_OUT_WIDTH]
	...
	*/
	...
	#pragma HLS LOOP_TRIPCOUNT min=1 max=3
			...
			//This loop selects which Tm no. of kernels are to be used ( here 2 , hencei=0-> 1&2 i=1->3&4.i=2->5&6),total kernel=6
	...
	//#pragma HLS PIPELINE II=1
					...
					float partial_IFM[2][14][14]; // Tn Ri Ci
					float partial_F[1][2][5][5];  // always 1 , then K x K
					float partial_OFM[1][10][10]; // 1 Ro Co ( 1 always)
	...
	#pragma HLS ARRAY_PARTITION variable=partial_OFM complete dim=2
	...
	#pragma HLS UNROLL
					...
					padded_ring_1_conv2d(partial_IFM,partial_F,partial_OFM);
	...
	#pragma HLS UNROLL
				...
				if(Qn!=0){
					float extra_par_IFM[1][14][14];  // Qn Ri Ci
					float extra_par_F[1][1][5][5];
	...
	#pragma HLS ARRAY_PARTITION variable=extra_partial_OFM complete dim=2
	...
	#pragma HLS UNROLL
					...
					padded_ring_2_conv2d(extra_par_IFM,extra_par_F,extra_partial_OFM);
	...
	//#pragma HLS PIPELINE II=1
				...
				float partial_IFM2[2][14][14];
				float partial_F2[1][2][5][5];
	...
	#pragma HLS ARRAY_PARTITION variable=partial_OFM2 complete dim=2  // doing 2 instead of 1
	...
	#pragma HLS UNROLL
				...
				padded_ring_1_conv2d(partial_IFM2,partial_F2,partial_OFM2);
	...
	#pragma HLS UNROLL
			...
			float extra_par_IFM2[1][14][14];
			float extra_par_F2[1][1][5][5];
	...
	#pragma HLS ARRAY_PARTITION variable=extra_partial_OFM2 complete dim=2
	...
	#pragma HLS UNROLL
			...
			// function call-4
			padded_ring_2_conv2d(extra_par_IFM2,extra_par_F2,extra_partial_OFM2);
