...
#define KERNEL_CHANNELS_COM   1     // same as the no. of CONV_OUT_CHANNELS_1
...
float F[KERNEL_CHANNELS_COM][CONV_IN_CHANNELS_1][KERNEL_SIZE][KERNEL_SIZE],       //3x3x2x4 - 4 2 3 3
