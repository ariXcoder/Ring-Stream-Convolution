...
#define KERNEL_SIZE       3 // filter size
#define CONV_STRIDE       1
#define KERNEL_CHANNELS   6     // total no. of 3D kernels same as CONV_OUT_CHANNELS
...
int main(){
	...
	/*float IFM[6][6][6]={
					...
					{ // C=2
											{1.0f,2.0f,3.0f,1.0f,2.0f,3.0f},  // H-1
											{4.0f,5.0f,6.0f,4.0f,5.0f,6.0f,},  // H-2
											{7.0f,8.0f,9.0f,7.0f,8.0f,9.0f},  // H-3
											{1.0f,2.0f,3.0f,1.0f,2.0f,3.0f},  // H-4
											{1.0f,3.0f,4.0f,2.0f,3.0f,4.0f},  // H-5
											{2.0f,4.0f,5.0f,3.0f,4.0f,5.0f}  // H-6
	...
	parallel_conv2d(IFM,F,OFM);  // test case IFM : 8x8x6 , F: 3x3x6x6 , OFM : 6X6X6  Tn=4,Tm=2
